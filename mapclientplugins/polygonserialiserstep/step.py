...
class PolygonSerialiserStep(WorkflowStepMountPoint):
    ...
    def serialize(self, location):
        ...
        conf.setValue('fileFormat', self._config['fileFormat'])
        conf.setValue('fileLoc', self._config['fileLoc'])
        conf.endGroup()
    ...
    def deserialize(self, location):
        ...
        self._config['fileFormat'] = conf.value('fileFormat', 'stl')
        self._config['fileLoc'] = conf.value('fileLoc', '')
        conf.endGroup()
